...
public class EnergyWeapon : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        if (manager.attackerMask == (manager.attackerMask | (1 << gameObject.layer)))
            mask = manager.attackerMask;
        else
            mask = manager.defenderMask;
    }
    ...
    public void Shoot(Vector3 pos)
    {
        ...
        RaycastHit2D raycastHit = Physics2D.Raycast(pos, dir, weapon.Range, mask);
        if (raycastHit)
        {
